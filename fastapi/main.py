...
rutas_db = [
    ...
    Ruta(
        ...
        puntos=[
            ...
            PuntoDeInteres(id=4, nombre="Puerta del León", descripcion="", latitud=37.384436, longitud=-5.992186),
    ...
    Ruta(
        ...
        puntos=[
            PuntoDeInteres(id=32, nombre="Monasterio de San Jerónimo", descripcion="", latitud=37.423700, longitud=-5.986623),
    ...
    Ruta(
        ...
        puntos=[
            ...
            PuntoDeInteres(id=75, nombre="Calle Reyes Católicos", descripcion="", latitud=37.388732, longitud=-6.000085),
